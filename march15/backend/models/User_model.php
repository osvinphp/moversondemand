...
/*mannual login start*/
	...
	public function moveDetailHistory($message){
		...
		$getdata['hypertrackdata']=$this->db->query("SELECT hypertrackUserId from tbl_driverDetail where driver_id='".$getdata['booking_data'][0]->driver_id."'")->row();
	...
	public function select_data($selection,$tbl_name,$where=null,$order=null){
