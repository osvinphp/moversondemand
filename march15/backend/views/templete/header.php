...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url("public/img");?>">
    <!-- Bootstrap core CSS -->
    ...
    <link href="<?php echo base_url("public/css/style.css?v=1.1")?>" rel="stylesheet"> 
...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-timepicker/1.10.0/jquery.timepicker.js">
