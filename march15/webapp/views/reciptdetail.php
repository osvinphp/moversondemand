         ...
         <div class="col-sm-12 col-md-12 col-lg-8 col-lg-offset-2">
                  <div class="fare-details">
                    ...
                    <div class="fr-detail-section fr-detail-section2">
                      <div class="fr-detail-inner"><p class="label-fr">Subtotal</p><p class="value NUmber_Font"><?php echo "$".$pricing->total_price; ?></p></div>
                      <div class="fr-detail-inner"><p class="label-fr">Discount</p><p class="value NUmber_Font"><?php echo "$".$pricing->discount_price; ?></p></div>
                    </div> 
                    ...
                    <?php } elseif($moverDetails->status == 3){ if(!empty($bookData->discount_amount)){ ?>
                       <div class="fr-detail-section fr-detail-section3">
                        <div class="fr-detail-inner"><p class="label-fr">subtotal</p>
                          <p class="value NUmber_Font">$<?php echo $bookData->total_price;?></p>
                        </div>
                      </div>
                      <div class="fr-detail-inner">
                      ...
                      <div class="fr-detail-inner">
                        ...
                        <p class="value NUmber_Font">$<?php echo $bookData->total_price - $bookData->discount_amount ;?></p>
                      </div>
                    <?php }else{ ?>

                       <div class="fr-detail-section fr-detail-section3">
                        <div class="fr-detail-inner"><p class="label-fr">Total </p>
                          <p class="value NUmber_Font">$<?php echo $pricing->total_price;?></p>
                        </div>
                      </div>
