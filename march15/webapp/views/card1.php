...
//echo "<pre>";print_r($_SESSION['retryBook']);die;
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="WANt_PLay">
                                                        <h6>Are you sure you want to pay from this card?</h6>
                                                    </div>
                                                </div>
                                                <div class="add-card-content text-center"> <p><?php echo "xxxx xxxx xxxx ".$cardno; ?></p>
                                                    ...
                                                    <p>Note: First <?php echo $_SESSION['bookCharge']."%"; ?> and rest payment will be done from this card.</p>
                                                </div>
                                                <div class="modal-footer REmove_BORder">
                                                    <div class="PAy_TOcard">
                                                        <form action="/App/book_select_time/<?php echo $value->id; ?>" method="POST">
                                                            <input type="submit" name="reesubmit" value="Yes">
                                                        </form>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer REmove_BORder">
                                                    <div class="PAy_TOcard">
                                                        ...
                                                        <form action="/App/Cards/<?php echo $value->id; ?>" method="POST">
