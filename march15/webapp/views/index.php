<?php 
// print_r($_SESSION['sitePassord']);die;
if($this->uri->uri_string() == '' && empty($sitePass)){
	if(isset($_SESSION['sitePassord'])){
		$pop = '<div id="jkdwdk" class="overlay1">';
	}else{
		$pop = '<div id="popup1" class="overlay1">';
	}
}else{
	$pop = '<div id="jkdwdk" class="overlay1">';
}
...
<script>
    ...
    function attachSignin(element) {
            ...
            $.ajax({
                ...
                success:function(html){
                    if(html == 2){
                      ...
                      window.location.href = $base_url+'/myLogin';
                    }else{
                        console.log(hfsdgf);
                        return false;               
                    }
            ...
            <div class="row">
                <div class="col-md-7 col-sm-7">
                  <div class="GEt_free">
                    ...
                    <div class="banner-text"><h1><span>Welcome</span> to<br> Movers on Demand</h1><h4>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</h4><a href="<?php echo base_url("estimate");?>">Get a Free Estimate</a></div>
      ...
      <div >
                        ...
                        <button type="button" class="info-btn" data-toggle="modal" data-target="#myModals1">Forgotten pasword</button>
<div class="social-icon-if">
                        ...
                        <div class="SIghIn">
                            ...
                            <h4>Don't have an account? <a href="<?php echo base_url();?>Signup" > Create Now!</a></h4>
                        </div>
                    </div>
                   <!--  sign UP -->
...
<!-- <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myMoedal">Open Modal</button> -->
<!-- <div class="modal fade" id="myMoedal" role="dialog">
...
<!--   <div class="popup">
 ...
 // var check = $_SESSION['sitePassord']->id;
 	// if(check == ""){
	    // $(window).load(function(){
	    //    window.location.href = '<?php echo base_url("#popup1"); ?>';
	    // });
	// }else{
